;(function ( w, doc, undefined ) {
	...
	/**
	 * ADDED BY SARA
	 * Reset the active modals first focusable element for tab order to be corrected
	 * Last focusable element is left as is as this remains the close button
	 */
	ARIAmodal.resetFocusableElements = function (modal_id, content_id) {
		var thisModal = document.getElementById(modal_id)
		if (thisModal.querySelector("."+firstClass)){
			thisModal.querySelector("."+firstClass).classList.remove(firstClass)
		}
		var content = document.getElementById(content_id)
		var focusable = content.querySelectorAll(tabFocusElements)
